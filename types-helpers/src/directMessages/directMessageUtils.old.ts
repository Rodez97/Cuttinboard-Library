// import { IMessage, Recipient } from "../message";
// import { IDirectMessage } from "./IDirectMessage";

// export function getMessageSeen(msg: IMessage) {
//   return Boolean(
//     msg.seenBy &&
//       Object.values(msg.seenBy).length === 2 &&
//       Object.values(msg.seenBy).every((value) => value)
//   );
// }

// export function getSeenDBPath(msg: IMessage, uid: string) {
//   return `${msg.messageRefUrl}/seenBy/${uid}`;
// }
